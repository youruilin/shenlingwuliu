          ...
          <div class="filter-container">
            <el-row :gutter="60">
              ...
              <el-col :span="8">
                ...
                >
                  <el-select
                    v-model="operationalSearchFormData.signStatus"
                    clearable
                    placeholder="请选择"
                  >
                    <el-option
          ...
          >
            ...
            >
              <template slot-scope="scope">
                ...
                <span v-else-if="!scope.row.signStatus">未签收</span>
                <span v-else>拒收</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span v-if="scope.row.signRecipient === 1">本人</span>
                <span v-else>代收</span>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.operationalSearchFormData.taskType = 2
      ...
      this.operationalSearchFormData.signStatus = ''
      this.actualTime = []
      this.estimatedTime = []
      this.getList()
    },
